...
const ProductTabs = () => {
	...
	const sellerProducts = [
		{ id: 1, image: "/images/product1.png" },
		{ id: 2, image: "/images/product2.png" },
		{ id: 3, image: "/images/product3.png" },
		{ id: 4, image: "/images/product4.png" },
		{ id: 5, image: "/images/product5.png" },
	...
	return (
		<div>
			<div className="flex border-b mb-4 bg-orange-700 text-white">
				{tabs.map((tab) => (
					<button
						key={tab}
			...
			<div className="bg-white rounded shadow">{renderContent()}</div>
		</div>
	);
};
